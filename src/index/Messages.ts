...
const strings = new LocalizedStrings({
    en: {
        ...
        intro_second: `My interests in computing are mainly in distributed systems, computer networking and machine learning.`,
    ...
    zh: {
        ...
        intro_second: `在計算機科學的領域裏，我對分布式計算、電腦聯網和機器學習特別感興趣。`,
    ...
    jp: {
        ...
        intro_second: `コンピューターサイエンスの分野の中で、分散システム、コンピューターネットワークと機材機械学習を中心として勉強しています。`,
