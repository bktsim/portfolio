	...
	>
		<div>
			<div class="md:hidden flex items-center justify-between">
				<a
					class="inline-flex grow flex-row text-xl font-semibold dark:text-white"
					href="/"
					aria-label="Brand">Brendon Tsim</a
				>
				<button
					type="button"
		...
		>
			<div
				class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-center md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7"
			>
				<a
					class="font-bold text-xl md:py-6 text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500"
					class:selected={page === 'index'}
					href="/"
					aria-current="page">Home</a
				>
				<!-- <a
					class="font-semibold text-xl text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500"
					class:selected={page === 'account'}
					href="/">Account</a
				>-->
			</div>
		</div>
