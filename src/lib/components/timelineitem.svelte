<script>
	 ...
	 * @type {string[]}
	 */
	export let courseBulletPoints;
	/**
	 * @type {string}
	 */
	export let courseDate;
</script>

<div class="flex gap-x-3">
	<div class="w-16 text-end">
		<span class="text-base text-gray-500 dark:text-gray-400">{courseDate}</span>
	</div>
	...
	<div class="grow pt-0.5 pb-8">
		<h3 class="flex gap-x-1.5 font-normal text-2xl lg:text-3xl text-gray-800 dark:text-white">
			{courseName}
		</h3>
		<p class="mt-2 text-lg text-gray-600 dark:text-gray-400">
			{courseContent}
		</p>
		<p class="mt-4 font-base text-2xl text-gray-600 dark:text-gray-400">main duties:</p>
