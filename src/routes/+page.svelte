	...
	<div class="flex flex-col sm:flex-row justify-center py-12 sm:min-h-[50vh]">
		...
		<div class="flex flex-col justify-center ml-2 sm:ml-6 md:ml-14 mt-4 sm:mt-0">
			...
			<div class="flex flex-col">
				...
				>
					<svg
						class="flex-shrink-0 size-6 md:size-7 lg:size-8"
				...
				<a
					class="hs-tooltip inline-flex justify-center items-center size-10 text-center rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800 md:mx-2 lg:mx-4"
				...
				<a
					class="hs-tooltip inline-flex justify-center items-center size-10 text-center rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800 md:ml-2 lg:ml-4"
		...
		<div>
			...
			<div class="paragraph-container">
				<p class="paragraph">
					...
					(full stack, web, embedded, IoT, game dev), and a 4th year undergraduate student at The
				...
				<p class="paragraph">
					...
					especially FPS and Rhythm games (maimai!). As you can tell from my hobbies, I like being
					on the internet.
				</p>
				<p class="paragraph">
