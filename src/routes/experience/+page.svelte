...
<div class="flex flex-row justify-center">
	<div class="mt-14 max-w-[85rem] mx-8 sm:px-6 lg:px-8 mb-14">
		<div class="flex flex-col">
			<article class="section">
				...
				<div class="paragraph-container">
					...
					<p class="paragraph">
						...
						either as an upper-year course at UBC, or as an upper-year/graduate level course during
						my
					...
					<p class="paragraph">
						...
						really matter to me. I am a strong believer that developers should pick tools based on
						the task, and not the other way around. I am confident in picking up any other language
						and framework that is best suited for any task I tackle.
					</p>
				</div>
			</article>
			<article class="section">
				...
				<div class="paragraph-container">
					...
					<Job
						key="kaishing"
						companyName="Kai Shing Management Services"
						jobTitle="Software Engineer Intern"
						jobDates="May 2021 - Jul 2021"
			...
			<article class="section">
				...
				<div class="paragraph-container">
					<p class="paragraph">
						At UBC, I work as a teaching assistant for computer science courses covering low-level
						concepts, introducing students to concepts in discrete math, computer systems, computer
						architure, operating systems and computer hardware. More specifically, I have taught the
						following courses:
					</p>
			...
			<article class="section">
				...
				<div class="paragraph-container">
					<p class="paragraph">
						I do ROBLOX game development and freelance web development on the side and get paid for
						it.
					</p>
					<p class="paragraph">
						For web development, I made <a
							href="https://www.hashbot.io/"
							class="link"
							target="_blank">hashbot.io</a
						>, a website that advertises a Discord bot targeted at the Web3 community that stops
						spam and impersonation, monitoring over 10M+ users in real time.
					</p>
					<p class="paragraph">
						I also do game development, localization (Chinese-English) and graphics for ROBLOX
						games. I've made fully fleshed out clicker games from scratch (Homework Simulator)
						myself, and I've also worked in various game studios, including game studios with games
						that have over 3M+ unique plays. In the future, I plan to consolidate and list my work
						here instead - but for now, you can see my past work at my old google site <a
