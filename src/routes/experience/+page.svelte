...
<div class="mt-14 max-w-[70rem] mx-8 sm:mx-auto sm:px-6 lg:px-8 mb-14">
	<div class="flex flex-col">
		<article class="section">
			...
			<div class="paragraph-container">
				...
				<p class="paragraph">
					Aside from livestreaming-related computer science topics, I'm also interested in Operating
					Systems, Natural Language Processing (especially speech and information retrieval related
		...
		<article class="section">
			...
			<div class="paragraph-container">
				...
				<p class="paragraph">
					...
					I've made fully fleshed out clicker games from scratch (Homework Simulator) myself, and
					I've also worked in various game studios, including game studios with games that have over
					3M+ unique plays. In the future, I plan to consolidate and list my work here instead - but
					for now, you can see my past work at my old google site <a
